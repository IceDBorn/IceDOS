      ...
      in
      {
        ${username} = {
          ...
          home.file.".zen/pwas/user.js".text =
            if (cfg.applications.zen-browser.pwas.enable) then userJs else "";
        };
      }
    ) users;
}
