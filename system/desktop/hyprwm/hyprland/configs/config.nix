  ...
  options = with lib; {
    desktop.hyprland.config = mkOption {
      ...
      default = ''
        ...
        monitor = ${config.hardware.monitors.main.name},${config.hardware.monitors.main.resolution},${config.hardware.monitors.main.position},${config.hardware.monitors.main.scaling}
        ...
        monitor = ${config.hardware.monitors.secondary.name},${config.hardware.monitors.secondary.resolution},${config.hardware.monitors.secondary.position},${config.hardware.monitors.secondary.scaling}
